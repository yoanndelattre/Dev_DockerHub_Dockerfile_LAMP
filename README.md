* To change the name, username and password of the database, modify the 'DB_NAME' 'DB_USER' and 'DB_PASS' variables of the dockerfile file in the "Dockerfile_MySQL" folder or the docker-compose.yml file
